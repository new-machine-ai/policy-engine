...
| Hook/middleware factory | `Codex.make_user_prompt_hook(policy)`, `maf.create_governance_middleware(...)` | A closure or list the framework's own hook system runs. No kernel object needed. |
